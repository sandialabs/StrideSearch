...
struct DataLayoutTraits {
    ...
    static horiz_index_type getDataIndexFromTreeIndex(const Index tree_ind, const Index sizedim2) {
        return horiz_index_type({tree_ind/sizedim2, tree_ind%sizedim2});}
};
